...
def shopFunc():
    ...
    print("Turnip Seed Satchel: " + str(turnipSeedSatchelPrice) + " Credits")
    print("Carrot Seed Satchel: " + str(carrotSeedSatchelPrice) + " Credits")
    print("Potato Plant Satchel: " + str(potatoPlantSatchelPrice) + " Credits")
    print("Onion Seed Satchel: " + str(onionSeedSatchelPrice) + " Credits")
    print("Tomato Seed Satchel: " + str(tomatoSeedSatchelPrice) + " Credits")
    print("Wheat Seed Satchel: " + str(wheatSeedSatchelPrice) + " Credits")
    print("Corn Seed Satchel: " + str(cornSeedSatchelPrice) + " Credits")
    print("Watering Can: " + str(wateringCanPrice) + " Credits")
    print("")
    ...
    if (shopQuery == "Turnip" or "Turnip Seed Satchel" or "Turnip Satchel" and playerMoney == turnipSeedSatchelPrice):
        ...
        print("(Credits - " + str(turnipSeedSatchelPrice) + ")")
        ...
        print("Oh... you don't got enough Credits im afraid, come back when you have enough Credits to purchase this item")
    ...
    if (shopQuery == "Carrot" or "Carrot Seed Satchel" or "Carrot Satchel" and playerMoney == carrotSeedSatchelPrice):
        ...
        print("(Credits -" + str(carrotSeedSatchelPrice) + ")")
...
def buglistFunc():
    ...
    print("purchase everything in the store, despite only having 60 Credits to start")
    print("")
    print("FIXED BUGS:")
...
def checkFunc():
    ...
    if (checkQuery == "Money"):
        print("You currently have " + str(playerMoney) + " Credits")
        print("")
